    ...
    <section class="v-space-build-nav" >
        ...
        >
            <g id="Layer_1-2" data-name="Layer 1">
                <g>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'Creche'}"              class="Creche"            x="975" y="0" width="166" height="69" style="fill: #d2c8b4;"/>
                    ...
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'Hôtel Entreprises'}"   class="HotelEntreprise"   y="61" width="1200" height="71" style="fill: #aac8ff;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'Hôtel Entreprises'}"   class="HotelEntreprise"   x="975" y="390" width="225" height="88" style="fill: #aac8ff;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'FoodLab'}"             class="FoodLab"           x="70.0027" width="905.03136" height="69" style="fill: #fffe00;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'MakerLab'}"            class="MakerLab"          x="975" y="260" width="225" height="130" style="fill: #3a4bcc;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'LearningLab'}"         class="LearningLab"       x="225" y="260" width="750" height="130" style="fill: #ff6917;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'GrandLab'}"            class="GrandLab"           y="260" width="225" height="130" style="fill: #ffc78c;"/>
                    <rect :class="{'is-active': useRouter().currentRoute.value.name === 'Accueil'}"             class="Accueil"           y="390" width="225" height="88" style="fill: #f64a42;"/>
                    <g>
